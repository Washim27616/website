...
```
git clone https://github.com/pawbz/website.git
```
- Check that you're on the master branch both in the root directory, as well as in the subfolder content.
...
First navigate to the root directory of the website in your terminal. To pull the most recent changes from the github repository by running: 
...
After completion of all the changes, push them into github repository by running:
...
- Name the picture `firstname_lastname.jpg` and put it into `content/authors/<new directory>/`. 

#### Add your CV 
- Create a new directory in `content` to push your CV into it.
- Name your CV `firstname_lastname.pdf` and put it in `content/<new directory>/`.

#### Add your personal page 

You can create a new webpage by adding a new markdown file with your name into the `content/authors/` folder. Just copy the `tobias_gerstenberg.md` file, rename it, and adapt it to your needs. 
